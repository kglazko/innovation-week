...
import org.mozilla.focus.toolbar.ToolbarEvent.CAT
...
enum class ToolbarEvent {
    HOME, SETTINGS, BACK, FORWARD, RELOAD, LOAD_URL, TURBO, PIN_ACTION, CAT;
...
object ToolbarIntegration {
    ...
    private fun addToolbarButtons(
        ...
        */
        ...
        val catButton = BrowserToolbar.Button(R.drawable.ic_cat,
                context.getString(R.string.menu_cat),
                background = TOOLBAR_BUTTON_BACKGROUND) { onToolbarEvent(CAT, null, null) }
                .let { WorkaroundAction(it) }
        toolbar.addBrowserAction(catButton)
